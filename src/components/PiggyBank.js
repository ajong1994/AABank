...
export function PiggyBank({width, height}) {
    return (
        ...
        fill="#b5adff"></path>
        <circle data-name="layer2" cx="34.5" cy="14" r="8" fill="#f6c44b"></circle>
        <circle data-name="layer1" cx="48.5" cy="34" r="1" fill="#b5adff"></circle>
        ...
        stroke="#340097" stroke-linecap="butt" stroke-linejoin="round" stroke-width="1"></circle>
