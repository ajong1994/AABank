    ...
    <div className="flex flex-col bg-white h-full">
        <div className="flex flex-col w-56 h-full bg-white overflow-hidden shadow">
            ...
            <ul className="flex flex-col py-5">
                ...
                <li>
                    <Link className={((status.currentAdmin !== 'amcanlubo') && (status.currentAdmin !== 'ajong1994')) ? "hidden" :"flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-primary"} to='/register'>
                    <span className="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400">
